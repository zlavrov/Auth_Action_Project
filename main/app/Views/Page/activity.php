...
<?php RouterService::ShowComponent("head"); ?>
    <body class="text-center"> <!-- _PAGE-ACTIVITY_ -->
<?php RouterService::ShowComponent("navbar"); ?>
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1 class="h2">Page with Statistic of users activity</h1>
        ...
        <div class="block">
            <canvas class="my-4 w-100" id="VIEW_A"></canvas>
        </div>
        <div class="block">
            <canvas class="my-4 w-100" id="VIEW_B"></canvas>
        </div>
    </main>
